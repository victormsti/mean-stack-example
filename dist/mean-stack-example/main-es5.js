...
var AppComponent = /** @class */ (function () {
    function AppComponent(newService) {
        ...
        this.valButton = "Save";
        this.onSave = function (user, isValid) {
            var _this = this;
            user.mode = this.valButton;
            this.newService.saveUser(user).subscribe(function (data) {
                alert(data.data);
                _this.ngOnInit();
            }, function (error) { return _this.errorMessage = error; });
        };
        this.edit = function (kk) {
            this.id = kk._id;
            this.name = kk.name;
        ...
        this.delete = function (id) {
            var _this = this;
            this.newService.deleteUser(id).subscribe(function (data) {
                alert(data.data);
                _this.ngOnInit();
            }, function (error) { return _this.errorMessage = error; });
        };
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.newService.getUser().subscribe(function (data) {
            _this.repData = data;
        });
    };
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_common_service__WEBPACK_IMPORTED_MODULE_5__["CommonService"]],
...
var CommonService = /** @class */ (function () {
    ...
    CommonService.prototype.saveUser = function (user) {
...
module.exports = __webpack_require__(/*! /home/victorsilva/Documents/Development/mean-stack-example/src/main.ts */"./src/main.ts");
